...
from data_aware_dp.wide_resnet import WideResNet
...
def get_lr_model(input_dim=10, cuda=False):
...
def get_resnet18_privacy_model(num_classes=10, cuda=True, seed=None):
    if seed is not None:
        torch.manual_seed(seed)
...
def get_cifar10_wide_resnet(pretrained=False,
                            num_classes=10,
                            cuda=False,
                            seed=None):
    if seed is not None:
...
def get_cifar10_wide_resnet__2(depth=40,
                               widen_factor=4,
                               num_classes=10,
                               cuda=False,
                               seed=None):
