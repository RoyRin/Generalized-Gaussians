    ...
    def _prepare_model(
        ...
        *,
        ...
        if isinstance(module, AbstractGradSampleModule):
            if (module.batch_first != batch_first
    ...
    def save_checkpoint(
        ...
        *,
        ...
        if grad_clip_scheduler is not None:
            checkpoint_dict[
                "grad_clip_scheduler_state_dict"] = grad_clip_scheduler.state_dict(
                )
    ...
    def load_checkpoint(
        ...
        *,
        ...
        module.load_state_dict(checkpoint["module_state_dict"],
                               **(module_load_dict_kwargs or {}))
        self.accountant.load_state_dict(
            checkpoint["privacy_accountant_state_dict"])
        ...
        noise_scheduler_state_dict = checkpoint.pop(
            "noise_scheduler_state_dict", {})
        ...
        if grad_clip_scheduler is not None and len(
                grad_clip_scheduler_state_dict) > 0:
